                                        ...
                                        <table class="table-auto w-full text-left whitespace-no-wrap">
                                            ...
                                            <tbody>
                                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                                    ...
                                                    <td class="font-medium border-t-2 border-gray-200 px-4 py-3">
                                                        <a href="{{ route('task.edit', ['task' => $task->id]) }}" class="edit-button text-white rounded-md text-center bg-green-400 hover:bg-green-500 py-2 px-4 inline-flex items-center focus:outline-none">編集</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                            @endforeach
