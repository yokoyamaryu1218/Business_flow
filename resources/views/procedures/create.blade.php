            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('task.edit', ['task' => $task->id]) }}" class="inline-flex items-center text-base font-medium text-blue-700 hover:text-blue-600 dark:text-blue-400 dark:hover:text-white">
                            作業詳細
                        </a>
                    </div>
                </li>
                                        ...
                                        <div class="lg:w-2/3 mx-auto">
                                            ...
                                            <form method="POST" action="{{ route('procedure.create', ['id' => $task->id]) }}">
                                                ...
                                                <div class="Form-Item">
                                                    ...
                                                    <div id="add_waku_next" class="ml-2">
                                                        <button id="add_next" class="text-white rounded-md text-center bg-green-400 py-2 px-4 inline-flex items-center focus:outline-none addButton hover:bg-green-600">行追加</button>
                                                    </div>
                                                </div>
                                                <hr>
                                                ...
                                                <div class="Form-Item">
                                                    ...
                                                    <div id="add_waku_book" class="ml-2">
                                                        <button id="add_book" class="text-white rounded-md text-center bg-green-400 py-2 px-4 inline-flex items-center focus:outline-none addButton hover:bg-green-600">行追加</button>
                                                    </div>
                                                </div>
                                                <hr>
                                            ...
                                            <div style="display: none;">
                                                ...
                                                <div id="previous_select_ary">
                                                    ...
                                                    <div class="ml-2">
                                                        <button id="delete_previous" class="text-white rounded-md text-center bg-red-400 py-2 px-4 inline-flex items-center focus:outline-none hover:bg-red-600">行削除</button>
                                                    </div>
                                                </div>
                                                <div id="next_select_ary">
                                                    ...
                                                    <div class="ml-2">
                                                        <button id="delete_next" class="text-white rounded-md text-center bg-red-400 py-2 px-4 inline-flex items-center focus:outline-none hover:bg-red-600">行削除</button>
                                                    </div>
                                                </div>
