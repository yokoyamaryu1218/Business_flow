                            ...
                            <section class="text-gray-600 body-font">
                                <div class="container py-5 mx-auto flex flex-wrap">
                                    <div class="lg:w-2/3 mx-auto">
                                        ...
                                        <form method="POST" action="{{ route('task.procedure.store',['id' => $task->id]) }}">
                                            @csrf
                                            @method('post')
                                            ...
                                            <div class="Form-Item">
                                                ...
                                                <input type="text" class="Form-Item-Input" name="task_name" id="task_name" value="{{ $task->name }}" readonly>
