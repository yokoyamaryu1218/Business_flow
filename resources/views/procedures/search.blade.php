                        ...
                        <div class="sm:p-4">
                            ...
                            <div class="flex items-center">
                                ...
                                <body>
                                    ...
                                    <button type="button" class="flex mb-4 ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded" onclick="window.location.href = '{{ route('task.procedure.create', ['id' => $task_id]) }}'">手順登録</button>
                                </body>
                            </div>
                                ...
                                <div class="container py-10 mx-auto flex flex-wrap">
                                    <div class="lg:w-4/5 mx-auto">
                                        ...
                                        <div class="my-4 flex items-center justify-end">
                                            <form action="{{ route('task.procedure.procedure_search', ['id' => $task_id] ) }}" method="GET">
                                                @method('get')
                                        ...
                                        <table class="w-full table-auto">
                                            ...
                                            <tbody>
                                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                                    ...
                                                    <td class="font-medium border-t-2 border-gray-200 px-4 py-3">
                                                        <a href="{{ route('task.procedure.edit', ['id1' => $task_id, 'id2' => $procedure->id]) }}'" class="text-white bg-green-400 border-0 py-2 px-4 rounded hover:bg-green-500 focus:outline-none small-button">編集</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                            @endforeach
