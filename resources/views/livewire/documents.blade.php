<div class="relative bg-white shadow-lg rounded-md text-gray-900 z-20">
    <header class="flex items-center justify-between p-2">
        <h2 class="font-semibold">関連マニュアル <span class="ml-2 text-gray-500 text-sm">検索に時間がかかる場合があります</span></h2>
    ...
    <main class="p-2 text-center">
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-blue-500 dark:hover:bg-blue-500" onclick="window.location='{{ route('dashboard.procedures', ['id1' => $procedureId, 'id2' => $document->document_id]) }}'">
