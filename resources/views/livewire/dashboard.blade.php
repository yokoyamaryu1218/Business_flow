        ...
        <div class="p-4">
            ...
            <div class="ml-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    ...
                    @if ($index < 9) <div>
                        <a href="{{ route('dashboard.task_details', ['id' => $works->id]) }}" class="my-4 inline-flex items-center justify-start w-210 px-4 py-2 mb-2 text-sm font-bold text-black border border-gray-400 rounded-md hover:bg-red-500 hover:text-white hover:border-transparent sm:w-auto sm:mb-0" style="width: 250px;">
                ...
                @elseif ($index == 9)
                <div>
                    <a href="{{ route('dashboard.tasks') }}" class="my-4 inline-flex items-center justify-start w-210 px-4 py-2 mb-2 text-sm font-bold text-black border border-gray-400 rounded-md hover:bg-red-500 hover:text-white hover:border-transparent sm:w-auto sm:mb-0" style="width: 250px;">
    ...
    <div class="bg-opacity-25 mt-4">
        <div class="p-4">
            ...
            <div class="ml-12">
                ...
                @elseif ($index == 9)
                <div>
                    <a href="{{ route('dashboard.documents') }}" class="my-4 inline-flex items-center justify-start w-210 px-4 py-2 mb-2 text-sm font-bold text-black border border-gray-400 rounded-md hover:bg-blue-500 hover:text-white hover:border-transparent sm:w-auto sm:mb-0" style="width: 250px;">
