                        ...
                        <div class="p-4">
                            ...
                            <div class="flex items-center">
                                ...
                                <body>
                                    ...
                                    <button type="button" class="flex my-4 ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded" onclick="window.location.href = '{{ route('approval.index') }}'">承認待ち一覧</button>
                                </body>
                            </div>
