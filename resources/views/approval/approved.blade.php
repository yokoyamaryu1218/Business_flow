<x-app-layout>
    ...
    <div class="flex" id="section-1">
        <!-- サイドバーを追加 -->
        <div class="flex fixed left-0 bottom-0">
                        ...
                        <div class="sm:p-4">
                            ...
                            <div class="flex items-center">
                                ...
                                <body>
                                    ...
                                    <button type="button" class="flex my-4 ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded small-button" onclick="window.location.href = '{{ route('approval.index') }}'">承認待ち一覧</button>
                                </body>
                            </div>
                                                ...
                                                <table class="w-full table-auto">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                                            ...
                                                            <td class="font-medium border-t-2 border-gray-200 px-4 py-3">{{ date('Y-m-d', strtotime($procedure->approval_at)) }}</td>
                                            ...
                                            <div class="container px-5 py-1 mx-auto">
                                                <table class="w-full table-auto">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                                            <td class="font-medium border-t-2 border-gray-200 px-4 py-3">{{ date('Y-m-d', strtotime($routine->approval_at)) }}</td>
                                                ...
                                                <table class="w-full table-auto">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                                            ...
                                                            <td class="font-medium border-t-2 border-gray-200 px-4 py-3">{{ date('Y-m-d', strtotime($document->approval_at)) }}</td>
